...
- Updated `lstm_step` to use matrix multiplications instead of element-wise multiplications for internal state updates, and added a configurable `activations` tuple argument.
